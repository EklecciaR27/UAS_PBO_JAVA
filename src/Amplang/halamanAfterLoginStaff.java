 ...
 * @author ASUS
 */
public class halamanAfterLoginStaff extends javax.swing.JFrame {

    /**
     * Creates new form halamanUtama
     */
    public halamanAfterLoginStaff() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(halamanAfterLoginStaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new halamanAfterLoginStaff().setVisible(true);
            }
        });
    }
